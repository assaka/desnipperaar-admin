@component('emails._layout', ['title' => 'Groepdeal afgelast'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">Groepdeal afgelast</h1>

<p>De groepdeal voor <strong>{{ $deal->city }}</strong> op <strong>{{ $deal->pickup_date->format('l j F Y') }}</strong> gaat helaas niet door.</p>
