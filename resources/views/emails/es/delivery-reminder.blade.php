@component('emails.es._layout', ['title' => 'Entregamos su contenedor '.$visit->bon_number])
...
<p>Un breve recordatorio. Mañana, {{ $visit->planned_for->format('d-m-Y') }}, entregamos su
...
<table cellpadding="6" style="border-collapse:collapse;font-size:14px;margin:16px 0;">
    ...
    <tr><td style="background:#F5F5F5;font-weight:700;">Dirección de entrega</td><td>{{ $order->pickupAddressLine() }}</td></tr>
    @if ($firstPickup)
