...
{{-- Twee adressen naast elkaar, elk met een eigen kop, zodat in een oogopslag
     te zien is dat het er twee zijn en welk adres waarvoor dient. Er staat geen
     kop boven de twee: de kolommen zijn zelf de secties. Is er maar een adres,
     dan blijft het de gewone lijst met de naam erbij, onder de kop Adres. --}}
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:16px;">
    <tr>
        <td width="50%" valign="top" style="padding:0 12px 0 0;font-size:13px;line-height:1.6;">
            <div style="font-size:14px;font-weight:900;text-transform:uppercase;letter-spacing:0.05em;margin:24px 0 10px;border-bottom:2px solid #0A0A0A;padding-bottom:6px;">Dirección de facturación</div>
        ...
        <td width="50%" valign="top" style="padding:0 0 0 12px;font-size:13px;line-height:1.6;">
            <div style="font-size:14px;font-weight:900;text-transform:uppercase;letter-spacing:0.05em;margin:24px 0 10px;border-bottom:2px solid #0A0A0A;padding-bottom:6px;">Dirección de recogida</div>
...
<table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-bottom:16px;">
    ...
    @endif
    <tr>
        <td style="padding:4px 0;color:#555;font-size:12px;font-weight:700;">Servicio elegido</td>
    ...
    @if (!empty($coupon))
        <tr>
            <td style="padding:4px 0;color:#2E7D32;font-size:12px;" colspan="2">
                Código de descuento {{ $coupon['code'] }}
                @if (!empty($coupon['pct']))
