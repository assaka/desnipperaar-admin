@component('emails.es._layout', ['title' => 'Bienvenido al SnipperDag'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">Está suscrito.</h1>

<p>Gracias por suscribirse al SnipperDag. Un día al azar cada semana ofrecemos un {{ $pct }}% de descuento. Será el primero en enterarse en cuanto llegue ese día.</p>
