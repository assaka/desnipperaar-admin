@component('emails.fr._layout', ['title' => 'Livraison de votre conteneur '.$order->order_number])
...
<p>Un petit rappel. Demain, {{ $order->pickup_date->format('d-m-Y') }}, nous livrons votre
conteneur roulant scellé de 240 litres.</p>

<table cellpadding="6" style="border-collapse:collapse;font-size:14px;margin:16px 0;">
    <tr><td style="background:#F5F5F5;font-weight:700;">Jour de livraison</td><td><strong>{{ $order->pickup_date->format('d-m-Y') }}</strong></td></tr>
