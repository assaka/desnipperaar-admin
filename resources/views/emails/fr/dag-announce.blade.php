@component('emails.fr._layout', ['title' => 'DeSnipperaar Day'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">Aujourd'hui, c'est le DeSnipperaar Day.</h1>
...
<p style="font-size:13px;color:#555;margin-top:20px;">Le code est actif automatiquement aujourd'hui et expire à minuit. À bientôt pour le prochain DeSnipperaar Day.</p>

<p>L'équipe DeSnipperaar</p>

<p style="font-size:11px;color:#999;margin-top:24px;border-top:1px solid #EEE;padding-top:12px;">
    Vous recevez ceci parce que vous vous êtes inscrit au DeSnipperaar Day.
