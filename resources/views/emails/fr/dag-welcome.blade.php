@component('emails.fr._layout', ['title' => 'Bienvenue au SnipperDag'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">Vous êtes inscrit.</h1>

<p>Merci de votre inscription au SnipperDag. Un jour au hasard chaque semaine, nous offrons {{ $pct }}% de réduction. Vous serez le premier informé dès que ce jour arrive.</p>
