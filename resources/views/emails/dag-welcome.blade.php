@component('emails._layout', ['title' => 'Welkom bij SnipperDag'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">U bent aangemeld.</h1>

<p>Bedankt voor uw aanmelding voor SnipperDag. Eén willekeurige dag per week geven wij {{ $pct }}% korting. U bent als eerste op de hoogte zodra die dag er is.</p>
