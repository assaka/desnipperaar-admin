@component('emails._layout', ['title' => 'Wij brengen uw container '.$order->order_number])
...
<p>Een korte herinnering. Morgen, {{ $order->pickup_date->format('d-m-Y') }}, brengen wij uw
verzegelde rolcontainer van 240 liter.</p>

<table cellpadding="6" style="border-collapse:collapse;font-size:14px;margin:16px 0;">
    <tr><td style="background:#F5F5F5;font-weight:700;">Bezorgdag</td><td><strong>{{ $order->pickup_date->format('d-m-Y') }}</strong></td></tr>
