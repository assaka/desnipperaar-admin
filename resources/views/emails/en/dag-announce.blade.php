@component('emails.en._layout', ['title' => 'DeSnipperaar Day'])
<h1 style="font-size:22px;font-weight:900;margin:0 0 12px;">Today is DeSnipperaar Day.</h1>
...
<p style="font-size:13px;color:#555;margin-top:20px;">The code is active automatically today and expires at midnight. See you on the next DeSnipperaar Day.</p>

<p>Team DeSnipperaar</p>

<p style="font-size:11px;color:#999;margin-top:24px;border-top:1px solid #EEE;padding-top:12px;">
    You receive this because you signed up for DeSnipperaar Day.
