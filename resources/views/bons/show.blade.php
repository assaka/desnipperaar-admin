        ...
        <section>
            ...
            <div class="grid grid-cols-2 gap-3">
                <div>
                    ...
                    <input type="number" min="0" name="actual_boxes"
                           value="{{ old('actual_boxes', $bon->actual_boxes ?? $bon->order->box_count) }}" class="w-full border p-2">
                </div>
                <div>
                    ...
                    <input type="number" min="0" name="actual_containers"
                           value="{{ old('actual_containers', $bon->actual_containers ?? $bon->order->container_count) }}" class="w-full border p-2">
                </div>
            </div>
