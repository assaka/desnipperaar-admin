...
@php
    ...
    $T = [
        'nl' => [
            ...
            'cannot_sign' => 'De klant kan niet ondertekenen',
            'waiver_reason' => 'Reden (verplicht)',
            'waiver_ph' => 'Bijvoorbeeld geen tekenbevoegde aanwezig. Noteer wie de dozen in ontvangst heeft genomen.',
            'waiver_badge' => 'Afgerond zonder ondertekening',
            'waiver_by' => 'vastgelegd door',
            'waiver_hint' => 'Zonder handtekening geldt deze reden als aftekening. De bon wordt daarna verstuurd en gefactureerd zoals gebruikelijk.',
        ...
        'en' => [
            ...
            'cannot_sign' => 'The customer is unable to sign',
            'waiver_reason' => 'Reason (required)',
            'waiver_ph' => 'For example no authorised signatory present. Note who took receipt of the boxes.',
            'waiver_badge' => 'Completed without a signature',
            'waiver_by' => 'recorded by',
            'waiver_hint' => 'Without a signature this reason serves as sign-off. The bon is then sent and invoiced as usual.',
        ...
        'fr' => [
            ...
            'cannot_sign' => "Le client n'est pas en mesure de signer",
            'waiver_reason' => 'Motif (obligatoire)',
            'waiver_ph' => 'Par exemple aucun signataire habilité sur place. Notez qui a pris réception des boîtes.',
            'waiver_badge' => 'Clôturé sans signature',
            'waiver_by' => 'enregistré par',
            'waiver_hint' => "Sans signature, ce motif tient lieu de validation. Le bon est ensuite envoyé et facturé comme à l'accoutumée.",
        ...
        'es' => [
            ...
            'cannot_sign' => 'El cliente no está en condiciones de firmar',
            'waiver_reason' => 'Motivo (obligatorio)',
            'waiver_ph' => 'Por ejemplo ningún firmante autorizado presente. Anote quién recibió las cajas.',
            'waiver_badge' => 'Cerrado sin firma',
            'waiver_by' => 'registrado por',
            'waiver_hint' => 'Sin firma este motivo hace las veces de validación. El bon se envía y se factura como de costumbre.',
