...
<div class="brand">
    <table style="width:100%;"><tr>
        <td>DESNIPPERAAR</td>
        <td style="text-align:right;">{{ $invoice->isCreditNote() ? "CREDITFACTUUR" : "FACTUUR" }}</td>
    </tr></table>
</div>
        ...
        <div class="klant">
            ...
            <td class="doc-info">
                <table class="dates" style="width:100%;text-align:right;">
                    <tr><td class="k">{{ $invoice->isCreditNote() ? "Creditfactuurnummer" : "Factuurnummer" }}</td><td><strong>{{ $invoice->invoice_number }}</strong></td></tr>
